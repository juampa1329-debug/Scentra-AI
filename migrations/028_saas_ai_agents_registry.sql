...
INSERT INTO saas_ai_agent_plan_limits (
    plan_code, max_ai_agents, max_active_ai_agents, allowed_agent_types_json, builder_enabled, notes, updated_at
)
VALUES
  ('demo', 2, 1, '["advisor","sales","support","crm_intelligence","campaign_strategist","retention","operations","executive_summary","knowledge","workflow_architect"]'::jsonb, TRUE, 'Demo de 30 dias: explora AI Agents con ejecucion controlada.', NOW()),
  ('starter', 1, 1, '["advisor","sales","support","crm_intelligence","campaign_strategist","retention","operations","executive_summary","knowledge","workflow_architect"]'::jsonb, TRUE, 'Plan starter: un agente AI activo.', NOW()),
  ('basic', 1, 1, '["advisor","sales","support","crm_intelligence","campaign_strategist","retention","operations","executive_summary","knowledge","workflow_architect"]'::jsonb, TRUE, 'Plan basico: un agente AI activo.', NOW()),
  ('growth', 3, 3, '["advisor","sales","support","crm_intelligence","campaign_strategist","retention","operations","executive_summary","knowledge","workflow_architect"]'::jsonb, TRUE, 'Growth: equipo pequeno con varios agentes AI.', NOW()),
  ('pro', 6, 6, '["advisor","sales","support","crm_intelligence","campaign_strategist","retention","operations","executive_summary","knowledge","workflow_architect"]'::jsonb, TRUE, 'Pro: suite de agentes AI para operacion comercial.', NOW()),
  ('enterprise', 50, 50, '["advisor","sales","support","crm_intelligence","campaign_strategist","retention","operations","executive_summary","knowledge","workflow_architect"]'::jsonb, TRUE, 'Enterprise: limites negociables y gobierno avanzado.', NOW())
