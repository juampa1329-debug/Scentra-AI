...
REQUIRED_COLUMNS: dict[str, tuple[str, ...]] = {
    ...
    "saas_crm_custom_fields": ("id", "tenant_id", "field_key", "field_type", "is_active"),
    "saas_crm_pipelines": ("id", "tenant_id", "name", "industry_code", "is_default"),
    "saas_crm_pipeline_stages": ("id", "tenant_id", "pipeline_id", "stage_key", "label", "display_order"),
    "saas_crm_tasks": ("id", "tenant_id", "conversation_id", "title", "status", "due_at"),
    "saas_labels": ("id", "tenant_id", "name", "color"),
    "saas_conversation_labels": ("tenant_id", "conversation_id", "label_id"),
    "saas_message_templates": ("id", "tenant_id", "name", "body", "status"),
    "saas_segments": ("id", "tenant_id", "name", "filters_json", "status"),
    "saas_campaigns": ("id", "tenant_id", "name", "status", "preflight_json"),
    "saas_crm_triggers": ("id", "tenant_id", "name", "is_active", "preflight_json"),
    "saas_remarketing_flows": ("id", "tenant_id", "name", "status", "preflight_json"),
    "saas_campaign_quiet_hours": ("id", "tenant_id", "channel", "is_enabled"),
    "saas_vertical_pack_applications": ("id", "tenant_id", "industry_code", "status", "created_at"),
