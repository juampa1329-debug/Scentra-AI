...
function App() {
  ...
  const [integrationForm, setIntegrationForm] = useState({ provider: "meta", channel: "whatsapp", status: "connected", dispatch_mode: "stub", phone_number_id: "", business_account_id: "", graph_api_version: "v24.0", access_token: "", access_token_env: "SCENTRA_META_ACCESS_TOKEN" });
  ...
  const saveIntegration = async (event) => {
    ...
    try {
      ...
      setIntegrationForm((prev) => ({ ...prev, access_token: "" }));
